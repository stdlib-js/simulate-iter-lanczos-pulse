...
<div class="equation" align="center" data-raw-text="f(t; T, \tau, a, \varphi) = \begin{cases}\operatorname{sinc}\biggl( \frac{2(t-\varphi)}{\tau-1} - 1\biggr) &amp; (t-\varphi) \mod T < \tau \\ 0 &amp; \textrm{otherwise} \end{cases}" data-equation="eq:lanczos_pulse_waveform">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/4fa8f0c0d831199775879b44805649a741cf37ce/lib/node_modules/@stdlib/simulate/iter/lanczos-pulse/docs/img/equation_lanczos_pulse_waveform.svg" alt="Equation for a Lanczos pulse waveform.">
    <br>
</div>
...
[test-image]: https://github.com/stdlib-js/simulate-iter-lanczos-pulse/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/simulate-iter-lanczos-pulse/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/simulate-iter-lanczos-pulse
